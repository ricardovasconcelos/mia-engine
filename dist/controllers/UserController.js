...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.store = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var repository, _a, name, email, password, userExists, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        userExists = _b.sent();
                        if (userExists) {
                            return [2 /*return*/, response.sendStatus(409)];
                        }
                        user = repository.create({ name: name, email: email, password: password });
